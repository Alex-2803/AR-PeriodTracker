...
const Settings: React.FC = () => {
  ...
  const clinicInfo = {
    name: "Ob-Gyn/Plus",
    doctors: [
      { name: "Dr. Sarah Johnson", role: "Medical Advisor" },
      { name: "Dr. Michael Chen", role: "Pediatric Specialist" }
    ],
    socialMedia: {
      website: "https://obgynplus.com",
      instagram: "https://instagram.com/obgynplus",
      twitter: "https://twitter.com/obgynplus",
      facebook: "https://facebook.com/obgynplus"
    }
  };
    ...
    <AppLayout>
      ...
      <div className="px-6 py-6">
        ...
        <IonCard className="mb-6 rounded-2xl">
          ...
          <IonCardContent>
            <div className="p-4 mb-6 text-center bg-gradient-to-r from-[#4e9dbf]/10 to-[#7dbdc8]/10 rounded-xl">
              <h2 className="mb-2 text-2xl font-bold text-[#2c5c6c]">{clinicInfo.name}</h2>
              <p className="text-sm text-[#2c5c6c]">Medical Advisory & Consultation</p>
            </div>
            ...
            <div className="mb-6 space-y-4">
              ...
              {clinicInfo.doctors.map((doctor, index) => (
                <div key={index} className="flex items-center p-3 space-x-4 bg-gray-50 rounded-xl">
                  <div className="flex items-center justify-center w-12 h-12 bg-white rounded-full shadow-sm">
                    <IonIcon icon={person} className="text-2xl text-[#4e9dbf]" />
                  </div>
            ...
            <div>
              ...
              <div className="flex justify-center space-x-4">
                ...
                <IonButton 
                  fill="clear" 
                  size="small"
                  onClick={() => window.open(clinicInfo.socialMedia.twitter, '_blank')}
          ...
          <IonCardContent>
            <div className="flex items-center justify-center p-4 mb-4 bg-gradient-to-r from-[#e2a31d]/10 to-[#ffb347]/10 rounded-xl">
              <div className="w-20 h-20 rounded-full bg-gradient-to-br from-[#7dbdc8] to-[#4e9dbf] flex items-center justify-center">
                <IonIcon icon={brush} className="text-3xl text-white" />
              </div>
            </div>
            ...
            <div className="space-y-4">
              {teamMembers.map((member, index) => (
                <div key={index} className="flex items-center p-4 space-x-4 bg-white border border-gray-200 rounded-xl">
                  <div className={`w-16 h-16 rounded-full bg-gradient-to-br ${member.avatarColor} flex items-center justify-center`}>
                    <IonIcon icon={briefcase} className="text-xl text-white" />
                  </div>
                  <div className="flex-1">
